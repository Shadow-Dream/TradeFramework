...
namespace QuantConnect.Brokerages
{
    ...
    /// </summary>
    public class DefaultBrokerageModel : IBrokerageModel, IModule
    {
        ...
        {
            _moduleState = new ModuleState(GetType(), ModuleKind.MarketRule, ModuleHotSwapMode.RequiresFlatNoOrders);
