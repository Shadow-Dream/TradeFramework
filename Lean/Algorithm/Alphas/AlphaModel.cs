...
namespace QuantConnect.Algorithm.Framework.Alphas
{
    ...
    /// </summary>
    public class AlphaModel : BasePythonWrapper<AlphaModel>, IAlphaModel, INamedModel, IModule
    {
        ...
        public AlphaModel()
        {
            _moduleState = new ModuleState(GetType(), ModuleKind.Signal, ModuleHotSwapMode.Live);
