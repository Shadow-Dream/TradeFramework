...
{
    internal sealed class TransportInputModule : IInputModule, IDisposable
    {
        ...
        public TransportInputModule(IModuleTransportClient client, ModuleActivationMode activationMode)
        {
        ...
        public ModuleKind Kind => ModuleKind.Input;
        ...
        {
            return TransportProtocol.DeserializeInputs(_client.InvokeAsync("register_inputs", TransportProtocol.SerializeTime(algorithm)).GetAwaiter().GetResult());
        }
