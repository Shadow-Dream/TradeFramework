...
{
    internal sealed class TransportTargetModule : IPortfolioConstructionModel, IModule, IDisposable
    {
        ...
        public TransportTargetModule(IModuleTransportClient client, ModuleActivationMode activationMode)
        {
        ...
        public ModuleKind Kind => ModuleKind.Target;
        ...
        {
            var payload = _client.InvokeAsync("create_targets", TransportProtocol.SerializeInsights(algorithm, insights)).GetAwaiter().GetResult();
