export const APP_NAME = "TradeEngine Agent"
export const CLI_COMMAND = "trade-agent"
export const DATA_ROOT_NAME = ".trade-agent"
export const DEV_DATA_ROOT_NAME = ".trade-agent-dev"
export const PACKAGE_NAME = "trade-engine-agent-web"
export const RUNTIME_PROFILE_ENV_VAR = "TRADE_AGENT_RUNTIME_PROFILE"
// Read version from package.json — JSON import works in both Bun and Vite
import pkg from "../../package.json"
export const APP_VERSION = pkg.version
export const SDK_CLIENT_APP = `trade-engine-agent/${pkg.version}`
export const LOG_PREFIX = "[trade-agent]"
