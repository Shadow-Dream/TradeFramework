...
def main():
    ...
    temp_dir = Path(tempfile.mkdtemp(prefix="lean-remote-script-hotswap-"))
    ...
    try:
        ...
        print(f"REMOTE_SCRIPT_HOTSWAP_SMOKE_OK log={output_path}", flush=True)
    finally:
